import { defineComponent, ref, onMounted, resolveComponent, unref, openBlock, createBlock, mergeProps, withCtx, createElementBlock, Fragment, renderList, resolveDynamicComponent, renderSlot, createCommentVNode, createVNode, nextTick } from "vue";
  ...
  setup(__props, { expose, emit: emits }) {
    ...
    return (_ctx, _cache) => {
      ...
      return unref(model) ? (openBlock(), createBlock(_component_el_form, mergeProps({
        ...
        model: unref(model),
        rules: unref(rules)
      }, _ctx.$attrs, { "validate-on-rule-change": false }), {
        default: withCtx(() => [
            ...
            return openBlock(), createElementBlock(Fragment, { key: index2 }, [
              !item.children || !item.children.length ? (openBlock(), createBlock(_component_el_form_item, {
                ...
                default: withCtx(() => [
                  item.type !== "upload" && item.type !== "editor" ? (openBlock(), createBlock(resolveDynamicComponent(`el-${item.type}`), mergeProps({ key: 0 }, item.attrs, {
                  ...
                  }), null, 16, ["modelValue", "onUpdate:modelValue", "placeholder"])) : item.type === "upload" ? (openBlock(), createBlock(_component_el_upload, mergeProps({ key: 1 }, item.uploadAttrs, {
                    ...
                    _: 2
                  }, 1040, ["on-preview", "on-remove", "on-success", "on-error", "on-progress", "on-change", "before-upload", "before-remove", "http-request", "on-exceed"])) : item.type === "editor" ? (openBlock(), createElementBlock("div", _hoisted_1)) : createCommentVNode("", true)
                ]),
                _: 2
