...
var index_vue_vue_type_style_index_0_scoped_true_lang = /* @__PURE__ */ (() => "svg[data-v-ff85a13a]{margin-right:4px;width:1em;height:1em}.el-menu-vertical-demo[data-v-ff85a13a]:not(.el-menu--collapse){width:200px}\n")();
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(__props.data, (item, i) => {
            return openBlock(), createElementBlock(Fragment, { key: i }, [
              ...
              item[__props.children] && item[__props.children].length ? (openBlock(), createBlock(_component_el_sub_menu, {
                ...
                default: withCtx(() => [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(item[__props.children], (sub, index1) => {
                    return openBlock(), createBlock(_component_el_menu_item, {
                      index: sub[__props.index],
                      key: index1
                    }, {
                      default: withCtx(() => [
                        sub[__props.icon] ? (openBlock(), createBlock(resolveDynamicComponent(`el-icon-${unref(toLine)(sub[__props.icon])}`), { key: 0 })) : createCommentVNode("", true),
                        createElementVNode("span", null, toDisplayString(sub[__props.name]), 1)
                      ]),
                      _: 2
                    }, 1032, ["index"]);
                  }), 128))
...
var menu = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-ff85a13a"]]);
